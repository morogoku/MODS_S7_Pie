...
.method public constructor <init>(Lcom/android/server/connectivity/MultipathPolicyTracker;Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    :try_end_21
    .catch Ljava/lang/ClassCastException; {:try_start_11 .. :try_end_21} :catch_82
    .catch Ljava/lang/NullPointerException; {:try_start_11 .. :try_end_21} :catch_82
    .catch Ljava/lang/NumberFormatException; {:try_start_11 .. :try_end_21} :catch_82

    nop

    # getter for: Lcom/android/server/connectivity/MultipathPolicyTracker;->mContext:Landroid/content/Context;
...
.method private getDailyNonDefaultDataUsage()J
    ...
    # getter for: Lcom/android/server/connectivity/MultipathPolicyTracker;->mClock:Ljava/time/Clock;
...
.method private getUserPolicyOpportunisticQuotaBytes()J
    ...
    # getter for: Lcom/android/server/connectivity/MultipathPolicyTracker;->mNPM:Landroid/net/NetworkPolicyManager;
    ...
    # invokes: Lcom/android/server/connectivity/MultipathPolicyTracker;->getActiveWarning(Landroid/net/NetworkPolicy;J)J
    ...
    # invokes: Lcom/android/server/connectivity/MultipathPolicyTracker;->getActiveLimit(Landroid/net/NetworkPolicy;J)J
...
.method private maybeUnregisterUsageCallback()V
    ...
    # getter for: Lcom/android/server/connectivity/MultipathPolicyTracker;->mStatsManager:Landroid/app/usage/NetworkStatsManager;
...
.method private registerUsageCallback(J)V
    ...
    # getter for: Lcom/android/server/connectivity/MultipathPolicyTracker;->mHandler:Landroid/os/Handler;
...
.method updateMultipathBudget()V
    ...
    # invokes: Lcom/android/server/connectivity/MultipathPolicyTracker;->getDefaultDailyMultipathQuotaBytes()J
