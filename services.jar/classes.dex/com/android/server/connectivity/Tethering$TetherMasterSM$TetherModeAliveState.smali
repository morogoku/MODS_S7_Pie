...
.method private setDVFS()V
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mCpuCoreBooster:Lcom/samsung/android/os/SemDvfsManager;
    ...
    # setter for: Lcom/android/server/connectivity/Tethering;->mCpuCoreBooster:Lcom/samsung/android/os/SemDvfsManager;
    invoke-static {v2, v5}, Lcom/android/server/connectivity/Tethering;->access$6102(Lcom/android/server/connectivity/Tethering;Lcom/samsung/android/os/SemDvfsManager;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mCpuCoreBooster:Lcom/samsung/android/os/SemDvfsManager;
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$6100(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    # setter for: Lcom/android/server/connectivity/Tethering;->supportedCPUCoreTable:[I
    invoke-static {v2, v5}, Lcom/android/server/connectivity/Tethering;->access$6202(Lcom/android/server/connectivity/Tethering;[I)[I

    iget-object v2, p0, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherModeAliveState;->this$1:Lcom/android/server/connectivity/Tethering$TetherMasterSM;

    iget-object v2, v2, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->this$0:Lcom/android/server/connectivity/Tethering;

    # getter for: Lcom/android/server/connectivity/Tethering;->supportedCPUCoreTable:[I
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->supportedCPUCoreTable:[I
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$6200(Lcom/android/server/connectivity/Tethering;)[I
    ...
    invoke-virtual {v3, v5}, Lcom/samsung/android/os/SemDvfsManager;->setDvfsValue(I)V
    ...
    invoke-virtual {v5, v3}, Lcom/samsung/android/os/SemDvfsManager;->setDvfsValue(I)V
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mCpuBooster:Lcom/samsung/android/os/SemDvfsManager;
    ...
    # setter for: Lcom/android/server/connectivity/Tethering;->mCpuBooster:Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-virtual {v3, v5, v6}, Lcom/samsung/android/os/SemDvfsManager;->getApproximateFrequencyByPercent(D)I
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mCpuBooster:Lcom/samsung/android/os/SemDvfsManager;
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering;->access$6300(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-virtual {v4, v6}, Lcom/samsung/android/os/SemDvfsManager;->setDvfsValue(I)V
    ...
    # setter for: Lcom/android/server/connectivity/Tethering;->mCpuBooster:Lcom/samsung/android/os/SemDvfsManager;
    invoke-static {v4, v6}, Lcom/android/server/connectivity/Tethering;->access$6302(Lcom/android/server/connectivity/Tethering;Lcom/samsung/android/os/SemDvfsManager;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->cstateDisable:Lcom/samsung/android/os/SemDvfsManager;
    ...
    # setter for: Lcom/android/server/connectivity/Tethering;->cstateDisable:Lcom/samsung/android/os/SemDvfsManager;
    ...
    monitor-exit v0
    :try_end_1a4
    .catchall {:try_start_9 .. :try_end_1a4} :catchall_1a2
