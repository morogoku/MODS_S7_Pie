...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    if-eq v2, v10, :cond_28f3

    const v10, 0x4fb7d6e9    # 6.1686298E9f

    if-eq v2, v10, :cond_28e6
    ...
    if-eq v2, v10, :cond_29bc

    const v10, -0x148747ff

    if-eq v2, v10, :cond_29af

    const v10, 0x37b7b049

    if-eq v2, v10, :cond_29a2

    const v10, 0x7a36baec

    if-eq v2, v10, :cond_2996
    ...
    if-eqz v10, :cond_2d0b

    invoke-interface {v10}, Ljava/util/List;->isEmpty()Z

    move-result v11

    if-nez v11, :cond_2d0b
    ...
    if-eqz v10, :cond_2d5f

    invoke-interface {v10}, Ljava/util/List;->isEmpty()Z

    move-result v11

    if-nez v11, :cond_2d5f
    ...
    move-result-object v0
    :try_end_2ea9
    .catch Ljava/net/URISyntaxException; {:try_start_2ea3 .. :try_end_2ea9} :catch_2eac
    ...
    :sswitch_data_3686
    .sparse-switch
        -0x777467f8 -> :sswitch_2c28
        -0x75f653b4 -> :sswitch_2c1b
        -0x526f4ac4 -> :sswitch_2c0e
        -0x4de6cfb2 -> :sswitch_2c01
        -0x4378abac -> :sswitch_2bf5
        -0x42f2906e -> :sswitch_2be8
        -0x308e1a98 -> :sswitch_2bdc
        -0x29404601 -> :sswitch_2bcf
        -0x2360eeb0 -> :sswitch_2bc2
        -0xf8e19f3 -> :sswitch_2bb5
        0x14014325 -> :sswitch_2ba8
        0x16233ecf -> :sswitch_2b9b
        0x1a458c22 -> :sswitch_2b8e
        0x1e373fed -> :sswitch_2b81
        0x21074337 -> :sswitch_2b75
        0x22e592aa -> :sswitch_2b68
        0x2383ddea -> :sswitch_2b5b
        0x2952fe03 -> :sswitch_2b4f
        0x2d2b575b -> :sswitch_2b42
        0x2dd7b5a9 -> :sswitch_2b35
        0x38dd3e65 -> :sswitch_2b28
        0x3c119522 -> :sswitch_2b1b
        0x3c3b0102 -> :sswitch_2b0f
        0x3d4c4243 -> :sswitch_2b02
        0x3d73f371 -> :sswitch_2af5
        0x49cef874 -> :sswitch_2ae9
        0x767a17ac -> :sswitch_2adc
    .end sparse-switch
