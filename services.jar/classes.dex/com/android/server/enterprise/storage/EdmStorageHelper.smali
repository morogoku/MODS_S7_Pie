...
.method private static addCidColumnForRCP(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)Z
    ...
    :try_end_30
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_30} :catch_110
    .catchall {:try_start_3 .. :try_end_30} :catchall_10e
    ...
    :try_end_10d
    .catch Ljava/lang/Exception; {:try_start_3c .. :try_end_10d} :catch_110
    .catchall {:try_start_3c .. :try_end_10d} :catchall_10e
    ...
    invoke-static {v1, v2}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_12d
    .catchall {:try_start_111 .. :try_end_12d} :catchall_10e
...
.method private static addContainerIdColumn(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)Z
    ...
    :try_end_1b
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_1b} :catch_d9
    .catchall {:try_start_3 .. :try_end_1b} :catchall_d7
    ...
    invoke-virtual {p0}, Landroid/database/sqlite/SQLiteDatabase;->setTransactionSuccessful()V
    :try_end_d6
    .catch Ljava/lang/Exception; {:try_start_20 .. :try_end_d6} :catch_d9
    .catchall {:try_start_20 .. :try_end_d6} :catchall_d7
    ...
    invoke-static {v1, v2}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_f5
    .catchall {:try_start_da .. :try_end_f5} :catchall_d7
...
.method private static addISAPackageNameColumn(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)Z
    ...
    invoke-static {v1, v2}, Lcom/android/server/enterprise/log/Log;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1b
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_1b} :catch_14b
    .catchall {:try_start_3 .. :try_end_1b} :catchall_149
    ...
    invoke-virtual {p0}, Landroid/database/sqlite/SQLiteDatabase;->setTransactionSuccessful()V
    :try_end_148
    .catch Ljava/lang/Exception; {:try_start_20 .. :try_end_148} :catch_14b
    .catchall {:try_start_20 .. :try_end_148} :catchall_149
...
.method private static getCount(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;)I
    ...
    :try_end_60
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_60} :catch_68
    .catchall {:try_start_3 .. :try_end_60} :catchall_66
...
.method private static getTableColumns(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Landroid/content/ContentValues;
    ...
    :try_end_47
    .catch Ljava/lang/Exception; {:try_start_19 .. :try_end_47} :catch_6d
    .catchall {:try_start_19 .. :try_end_47} :catchall_6b
    ...
    .catchall {:try_start_4e .. :try_end_64} :catchall_6b
    ...
    invoke-static {v4, v5}, Lcom/android/server/enterprise/log/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_85
    .catchall {:try_start_6e .. :try_end_85} :catchall_6b
...
.method private static postAdminTableCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {p0, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V
    :try_end_28
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_28} :catch_45
...
.method private static upgradeAdminTable(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)Z
    ...
    invoke-static {v3, v4}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_19
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_19} :catch_32
    ...
    invoke-static {p0}, Lcom/android/server/enterprise/storage/EdmStorageHelper;->postAdminTableCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    :try_end_2c
    .catch Ljava/lang/Exception; {:try_start_1e .. :try_end_2c} :catch_32
...
.method doCreationOrUpdatePostCommands(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    :try_end_73
    .catch Ljava/lang/Exception; {:try_start_47 .. :try_end_73} :catch_74
    ...
    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V
    :try_end_ea
    .catch Ljava/lang/Exception; {:try_start_75 .. :try_end_ea} :catch_eb
...
.method public doTablesCreationOrUpdate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    :try_end_3a
    .catch Ljava/lang/Exception; {:try_start_1c .. :try_end_3a} :catch_42
    .catchall {:try_start_1c .. :try_end_3a} :catchall_40
