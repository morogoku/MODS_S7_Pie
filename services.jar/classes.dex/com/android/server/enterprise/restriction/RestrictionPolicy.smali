...
.method public allowSecureStartUp(Lcom/samsung/android/knox/ContextInfo;Z)Z
    .registers 8
    ...
    const-string v2, "allowSecureStartUp : "
    ...
    const-string v4, "allowSecureStartUp"
...
.method public isScreenCaptureEnabledEx(IZ)Z
    ...
    move-result v5
    :try_end_32
    .catch Ljava/lang/Exception; {:try_start_15 .. :try_end_32} :catch_35
...
.method public isSecureStartUpAllowed(Lcom/samsung/android/knox/ContextInfo;)Z
    .registers 7
    ...
    const-string v3, "allowSecureStartUp"
    ...
    const-string/jumbo v4, "isSecureStartUpAllowed : "
...
.method public setAllowedFOTAVersion(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;Landroid/os/Bundle;Z)Z
    ...
    const-string/jumbo v6, "setAllowedFOTAVersion : ERROR_UPDATE_FOTA_INVALID_PARAMETER(version) "
    ...
    invoke-direct {p0, v3, v1, p2}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->getStatusSelectiveFota(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v4}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->sendSeletiveFotaResult(I)V
    ...
    const-string/jumbo v10, "setAllowedFOTAVersion : result = "
    ...
    const-string/jumbo v9, "setAllowedFOTAVersion : sendBroadcast : sec.fota.intent.MDM_REGISTER"

    invoke-static {v8, v9}, Lcom/android/server/enterprise/log/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    const-string v8, "com.wssyncmldm"

    const-string v9, "com.samsung.utagent"
...
.method public setScreenCapture(Lcom/samsung/android/knox/ContextInfo;Z)Z
    ...
    invoke-virtual {v4, v2}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getComponentNameForUid(I)Landroid/content/ComponentName;
    ...
    invoke-virtual {v5, v4, v6}, Landroid/app/admin/DevicePolicyManager;->setScreenCaptureDisabled(Landroid/content/ComponentName;Z)V
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isScreenCaptureEnabled(IZ)Z

    move-result v3

    xor-int/lit8 v3, v3, 0x1

    invoke-direct {p0, v0, v3}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->updateScreenCaptureDisabledInWindowManager(IZ)V
    ...
    const-string/jumbo v7, "setScreenCapture : getTopActivityUserId()= "
    ...
    iget-object v3, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->mWindowManager:Landroid/view/IWindowManager;

    invoke-interface {v3, v0}, Landroid/view/IWindowManager;->updateScreenshotPolicy(I)V
    :try_end_98
    .catch Ljava/lang/Exception; {:try_start_20 .. :try_end_98} :catch_9a
    ...
    invoke-virtual {v2, v6, v7, v8, p2}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putBoolean(ILjava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, p1, v3}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isScreenCaptureEnabled(Lcom/samsung/android/knox/ContextInfo;Z)Z
    ...
    invoke-static {v2, v6, v7}, Lcom/android/server/enterprise/utils/Utils;->writePropertyValue(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->updateScreenCaptureDisabledInWindowManager(IZ)V
    ...
    iget-object v2, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->mWindowManager:Landroid/view/IWindowManager;

    invoke-interface {v2, v0}, Landroid/view/IWindowManager;->updateScreenshotPolicy(I)V
    :try_end_157
    .catch Ljava/lang/Exception; {:try_start_b8 .. :try_end_157} :catch_158
