...
.method static synthetic access$6200(Lcom/android/server/display/DisplayManagerService$LocalService;)I
    .registers 2
...
.method static synthetic access$6702(Lcom/android/server/display/DisplayManagerService$LocalService;Z)Z
    .registers 2
...
.method public getCurrentScreenBrightness()I
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$5800(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayPowerController;
...
.method public getDefaultBuiltInDisplayId()I
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$8300(Lcom/android/server/display/DisplayManagerService;)I
...
.method public getDisplayInfo(I)Landroid/view/DisplayInfo;
    ...
    invoke-static {v0, p1, v1, v2}, Lcom/android/server/display/DisplayManagerService;->access$7100(Lcom/android/server/display/DisplayManagerService;III)Landroid/view/DisplayInfo;
...
.method public initPowerManagement(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;)V
    ...
    invoke-static {v1, v8}, Lcom/android/server/display/DisplayManagerService;->access$5802(Lcom/android/server/display/DisplayManagerService;Lcom/android/server/display/DisplayPowerController;)Lcom/android/server/display/DisplayPowerController;
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$7000(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayManagerService$DisplayManagerHandler;
...
.method public isDesktopSwitched()Z
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$8000(Lcom/android/server/display/DisplayManagerService;)Z
...
.method public isProximitySensorAvailable()Z
    ...
    # getter for: Lcom/android/server/display/DisplayManagerService;->mDisplayPowerController:Lcom/android/server/display/DisplayPowerController;
    invoke-static {v1}, Lcom/android/server/display/DisplayManagerService;->access$5800(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayPowerController;
...
.method public isUidPresentOnDisplay(II)Z
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/display/DisplayManagerService;->access$7900(Lcom/android/server/display/DisplayManagerService;II)Z
...
.method public onOverlayChanged()V
    ...
    invoke-static {v2}, Lcom/android/server/display/DisplayManagerService;->access$4500(Lcom/android/server/display/DisplayManagerService;)Ljava/util/ArrayList;
...
.method public registerDisplayBrightnessListener(Landroid/hardware/display/DisplayManagerInternal$DisplayBrightnessListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$8500(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayBrightnessListener;)V
...
.method public registerDisplayTransactionListener(Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$7200(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
...
.method public setDefaultBuiltInDisplayFromWindowManager(I)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$8200(Lcom/android/server/display/DisplayManagerService;I)V
...
.method public setDisplayAccessUIDs(Landroid/util/SparseArray;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$7800(Lcom/android/server/display/DisplayManagerService;Landroid/util/SparseArray;)V
...
.method public setDisplayInfoOverrideFromWindowManager(ILandroid/view/DisplayInfo;)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/display/DisplayManagerService;->access$7400(Lcom/android/server/display/DisplayManagerService;ILandroid/view/DisplayInfo;)V
...
.method public setDisplayOffsets(III)V
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/android/server/display/DisplayManagerService;->access$7700(Lcom/android/server/display/DisplayManagerService;III)V
...
.method public setDisplayProperties(IZFIZ)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/server/display/DisplayManagerService;->access$7600(Lcom/android/server/display/DisplayManagerService;IZFIZ)V
...
.method public setDisplayStateLimit(I)V
    ...
    invoke-static {v0, v3, v3, v1, v2}, Lcom/android/server/display/DisplayManagerService;->access$6800(Lcom/android/server/display/DisplayManagerService;IIII)V
    ...
    # invokes: Lcom/android/server/display/DisplayManagerService;->requestGlobalDisplayStateInternal(IIII)V
    invoke-static {v0, v1, v2, v3, v4}, Lcom/android/server/display/DisplayManagerService;->access$6800(Lcom/android/server/display/DisplayManagerService;IIII)V
...
.method public setScaledDisplaySize(III)V
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/android/server/display/DisplayManagerService;->access$8400(Lcom/android/server/display/DisplayManagerService;III)V
