...
.field private static final GET_PARAMETERS:Ljava/lang/String; = "getparams"
...
.field private static final SET_PARAMETERS:Ljava/lang/String; = "setparams"

.field private static final SET_PARAMETERS_FROM_SINK:Ljava/lang/String; = "params"
...
.field private mIsDmrSupported:Z
...
.field private remoteDisplayListener:Landroid/media/RemoteDisplay$RemoteDisplayListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/WifiDisplayController$Listener;Lcom/android/server/display/PersistentDataStore;)V
    ...
    iput-object v1, p0, Lcom/android/server/display/WifiDisplayController;->remoteDisplayListener:Landroid/media/RemoteDisplay$RemoteDisplayListener;
...
.method static synthetic access$4300(Lcom/android/server/display/WifiDisplayController;Ljava/lang/String;)V
    .registers 2
...
.method static synthetic access$4400(Lcom/android/server/display/WifiDisplayController;Landroid/hardware/display/WifiDisplay;Landroid/view/Surface;III)V
    .registers 6
...
.method static synthetic access$4900(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .registers 2
...
.method static synthetic access$4902(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .registers 2
...
.method static synthetic access$5100(Lcom/android/server/display/WifiDisplayController;Ljava/lang/String;)V
    .registers 2
...
.method static synthetic access$5300(Landroid/net/wifi/p2p/WifiP2pGroup;)Ljava/lang/String;
    .registers 2
...
.method static synthetic access$5400(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .registers 2
...
.method static synthetic access$5402(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .registers 2
...
.method static synthetic access$5700(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/WifiManager;
    .registers 2
...
.method static synthetic access$5900(Lcom/android/server/display/WifiDisplayController;)V
    .registers 1
...
.method static synthetic access$6000(Lcom/android/server/display/WifiDisplayController;Z)V
    .registers 2
...
.method static synthetic access$6200(Lcom/android/server/display/WifiDisplayController;Landroid/net/NetworkInfo;)V
    .registers 2
...
.method static synthetic access$6502(Lcom/android/server/display/WifiDisplayController;Z)Z
    .registers 2
...
.method static synthetic access$7402(Lcom/android/server/display/WifiDisplayController;I)I
    .registers 2
...
.method static synthetic access$7500(Lcom/android/server/display/WifiDisplayController;)Z
    .registers 2
...
.method static synthetic access$7600(Lcom/android/server/display/WifiDisplayController;ILandroid/os/Bundle;)V
    .registers 3
...
.method static synthetic access$7800(Lcom/android/server/display/WifiDisplayController;II)V
    .registers 3
...
.method static synthetic access$7900(Lcom/android/server/display/WifiDisplayController;I)V
    .registers 2
...
.method static synthetic access$8000(Lcom/android/server/display/WifiDisplayController;)Lcom/android/server/display/WifiDisplayController$WfdAppMonitor;
    .registers 2
...
.method static synthetic access$8002(Lcom/android/server/display/WifiDisplayController;Lcom/android/server/display/WifiDisplayController$WfdAppMonitor;)Lcom/android/server/display/WifiDisplayController$WfdAppMonitor;
    .registers 2
...
.method private connectWifiDisplayViaAp(Landroid/hardware/display/SemDeviceInfo;)V
    ...
    iget-object v4, p0, Lcom/android/server/display/WifiDisplayController;->remoteDisplayListener:Landroid/media/RemoteDisplay$RemoteDisplayListener;
    ...
    invoke-static/range {v3 .. v8}, Landroid/media/RemoteDisplay;->listen(Ljava/lang/String;Landroid/media/RemoteDisplay$RemoteDisplayListener;Landroid/os/Handler;Ljava/lang/String;Ljava/lang/String;Landroid/media/RemoteDisplay$NativeListener;)Landroid/media/RemoteDisplay;
...
.method private finish()V
    ...
    iput-boolean v0, p0, Lcom/android/server/display/WifiDisplayController;->mIsDmrSupported:Z
...
.method private getInitParam(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    const-string/jumbo v3, "getInitParam : "
    ...
    :try_end_141
    .catch Lorg/json/JSONException; {:try_start_6 .. :try_end_141} :catch_142
...
.method private getProcessNameByPid(I)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/display/WifiDisplayController$38;-><init>(Lcom/android/server/display/WifiDisplayController;I)V
...
.method private sendDeviceVolumeChangedEvent(ILandroid/os/Bundle;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/display/WifiDisplayController$29;-><init>(Lcom/android/server/display/WifiDisplayController;ILandroid/os/Bundle;)V
...
.method private sendRemoteDisplayStateChangeEvent(II)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/display/WifiDisplayController$28;-><init>(Lcom/android/server/display/WifiDisplayController;II)V
...
.method private sendSSRMRequestIntent(Z)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/display/WifiDisplayController$39;-><init>(Lcom/android/server/display/WifiDisplayController;Z)V
...
.method private sendWifiDisplayDmrSupportChangedEvent()V
    .registers 6
    ...
    invoke-virtual {v1}, Landroid/hardware/display/SemDeviceInfo;->getViewMode()Ljava/lang/String;
    ...
    const-string/jumbo v4, "sendWifiDisplayDmrSupportChangedEvent, mIsDmrSupported : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p0, Lcom/android/server/display/WifiDisplayController;->mIsDmrSupported:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/display/WifiDisplayController;->mIsDmrSupported:Z
    ...
    invoke-direct {v3, p0, v0}, Lcom/android/server/display/WifiDisplayController$31;-><init>(Lcom/android/server/display/WifiDisplayController;Z)V
...
.method private sendWifiDisplayNotifyEvent(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "sendWifiDisplayNotifyEvent : "
    ...
    const-string/jumbo v2, "wfd_sec_view_mode"
    ...
    invoke-virtual {v2, v3}, Landroid/hardware/display/SemDeviceInfo;->setViewMode(Ljava/lang/String;)V

    iget-object v2, p0, Lcom/android/server/display/WifiDisplayController;->mPersistentDataStore:Lcom/android/server/display/PersistentDataStore;

    iget-object v3, p0, Lcom/android/server/display/WifiDisplayController;->mConnectDeviceInfo:Landroid/hardware/display/SemDeviceInfo;

    invoke-virtual {v3}, Landroid/hardware/display/SemDeviceInfo;->getViewMode()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/android/server/display/PersistentDataStore;->setRememberedLastChangedViewMode(Ljava/lang/String;)Z
    ...
    const-string v4, "   wfd_sec_view_mode, view_mode : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p0, Lcom/android/server/display/WifiDisplayController;->mConnectDeviceInfo:Landroid/hardware/display/SemDeviceInfo;

    invoke-virtual {v4}, Landroid/hardware/display/SemDeviceInfo;->getViewMode()Ljava/lang/String;
    ...
    const-string v5, "   wfd_sec_dmr_support, isSupport : "
    ...
    invoke-virtual {v4, v3}, Landroid/hardware/display/SemDeviceInfo;->addFlag(I)V
    ...
    invoke-virtual {v4, v3}, Landroid/hardware/display/SemDeviceInfo;->removeFlag(I)V

    :goto_f2
    invoke-direct {p0}, Lcom/android/server/display/WifiDisplayController;->sendWifiDisplayDmrSupportChangedEvent()V
    ...
    invoke-direct {v3, p0, v0}, Lcom/android/server/display/WifiDisplayController$30;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/os/Bundle;)V

    invoke-virtual {v2, v3}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z
    :try_end_ff
    .catch Lorg/json/JSONException; {:try_start_19 .. :try_end_ff} :catch_100
...
.method private sendWifiDisplayPlayStateChangedEvent(I)V
    ...
    const-string/jumbo v2, "sendWifiDisplayPlayStateChangedEvent : "
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/display/WifiDisplayController$32;-><init>(Lcom/android/server/display/WifiDisplayController;I)V
...
.method private updateConnection()V
    ...
    iget-object v5, p0, Lcom/android/server/display/WifiDisplayController;->remoteDisplayListener:Landroid/media/RemoteDisplay$RemoteDisplayListener;
    ...
    invoke-virtual {v3}, Landroid/hardware/display/SemDeviceInfo;->getOption()Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v3}, Lcom/android/server/display/WifiDisplayController;->getInitParam(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-static/range {v4 .. v9}, Landroid/media/RemoteDisplay;->listen(Ljava/lang/String;Landroid/media/RemoteDisplay$RemoteDisplayListener;Landroid/os/Handler;Ljava/lang/String;Ljava/lang/String;Landroid/media/RemoteDisplay$NativeListener;)Landroid/media/RemoteDisplay;
