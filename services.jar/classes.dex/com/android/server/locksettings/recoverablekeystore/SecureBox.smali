...
.method private static aesGcmInternal(Lcom/android/server/locksettings/recoverablekeystore/SecureBox$AesGcmOperation;Ljavax/crypto/SecretKey;[B[B[B)[B
    ...
    move-result-object v0
    :try_end_6
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_0 .. :try_end_6} :catch_35
    ...
    invoke-virtual {v0, v2, p1, v1}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    :try_end_1c
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_f .. :try_end_1c} :catch_2e
    ...
    :try_end_24
    .catch Ljavax/crypto/AEADBadTagException; {:try_start_1d .. :try_end_24} :catch_2c
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_1d .. :try_end_24} :catch_25
    .catch Ljavax/crypto/BadPaddingException; {:try_start_1d .. :try_end_24} :catch_25
...
.method static decodePublicKey([B)Ljava/security/PublicKey;
    ...
    move-result-object v3
    :try_end_31
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_21 .. :try_end_31} :catch_32
...
.method private static hkdfDeriveKey([B[B[B)Ljavax/crypto/SecretKey;
    ...
    :try_end_10
    .catch Ljava/security/InvalidKeyException; {:try_start_6 .. :try_end_10} :catch_3e
    ...
    :try_end_1f
    .catch Ljava/security/InvalidKeyException; {:try_start_15 .. :try_end_1f} :catch_37
