...
.method private createSessionInternal(Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;I)I
    ...
    invoke-virtual {v2, v4, v13}, Lcom/android/server/pm/PackageManagerService;->checkUidPermission(Ljava/lang/String;I)I
    ...
    iget-object v2, v1, Lcom/android/server/pm/PackageInstallerService;->mAppOps:Landroid/app/AppOpsManager;

    invoke-virtual {v2, v13, v14}, Landroid/app/AppOpsManager;->checkPackage(ILjava/lang/String;)V
    ...
    invoke-virtual {v5, v6, v2, v2}, Lcom/android/server/pm/PackageManagerService;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    iget v0, v15, Landroid/content/pm/PackageInstaller$SessionParams;->installLocation:I

    or-int/lit8 v0, v0, 0x8

    iput v0, v15, Landroid/content/pm/PackageInstaller$SessionParams;->installLocation:I
    ...
    invoke-static {v0, v5}, Lcom/android/server/pm/PackageInstallerService;->buildNotification(Landroid/content/Context;Ljava/lang/String;)Landroid/app/Notification;
    ...
    invoke-virtual {v5, v14, v6, v0}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
    ...
    :try_end_256
    .catchall {:try_start_24e .. :try_end_256} :catchall_32a
    ...
    :goto_25a
    iget-object v6, v1, Lcom/android/server/pm/PackageInstallerService;->mSessions:Landroid/util/SparseArray;
    ...
    iget-object v4, v1, Lcom/android/server/pm/PackageInstallerService;->mHistoricalSessionsByInstaller:Landroid/util/SparseIntArray;

    invoke-virtual {v4, v13}, Landroid/util/SparseIntArray;->get(I)I

    move-result v4
    :try_end_270
    .catchall {:try_start_25d .. :try_end_270} :catchall_324
    ...
    monitor-exit v6
    :try_end_27e
    .catchall {:try_start_278 .. :try_end_27e} :catchall_2ea
    ...
    invoke-direct {v1, v3, v11, v2}, Lcom/android/server/pm/PackageInstallerService;->buildStageDir(Ljava/lang/String;IZ)Ljava/io/File;
    ...
    iget-object v0, v1, Lcom/android/server/pm/PackageInstallerService;->mSessions:Landroid/util/SparseArray;
    :try_end_2d0
    .catchall {:try_start_2ce .. :try_end_2d0} :catchall_2e5
    ...
    monitor-exit v3
    :try_end_2d6
    .catchall {:try_start_2d2 .. :try_end_2d6} :catchall_2e3
    ...
    monitor-exit v3
    :try_end_2e9
    .catchall {:try_start_2e8 .. :try_end_2e9} :catchall_2e3
    ...
    :try_end_2fb
    .catchall {:try_start_2ef .. :try_end_2fb} :catchall_308
    ...
    monitor-exit v6
    :try_end_327
    .catchall {:try_start_2fd .. :try_end_327} :catchall_328
...
.method public getMySessions(Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    monitor-exit v1
    :try_end_4f
    .catchall {:try_start_24 .. :try_end_4f} :catchall_55
