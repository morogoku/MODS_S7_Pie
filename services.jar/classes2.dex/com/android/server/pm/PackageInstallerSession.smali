...
.method public constructor <init>(Lcom/android/server/pm/PackageInstallerService$InternalCallback;Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Landroid/os/Looper;IILjava/lang/String;ILandroid/content/pm/PackageInstaller$SessionParams;JLjava/io/File;Ljava/lang/String;ZZ)V
    ...
    :try_end_b3
    .catch Lcom/android/server/pm/PackageManagerException; {:try_start_b0 .. :try_end_b3} :catch_b8
    .catch Ljava/io/IOException; {:try_start_b0 .. :try_end_b3} :catch_b8
    ...
    monitor-exit v4
    :try_end_c5
    .catchall {:try_start_b4 .. :try_end_c5} :catchall_b6
    ...
    :try_end_dd
    .catchall {:try_start_cc .. :try_end_dd} :catchall_127
...
.method private calculateInstalledSize()J
    ...
    move-result-object v4
    :try_end_c
    .catch Landroid/content/pm/PackageParser$PackageParserException; {:try_start_5 .. :try_end_c} :catch_8f
...
.method private commitLocked()V
    ...
    :try_end_12f
    .catch Ljava/io/IOException; {:try_start_76 .. :try_end_12f} :catch_130
...
.method private destroyInternal()V
    ...
    monitor-exit v0
    :try_end_35
    .catchall {:try_start_4 .. :try_end_35} :catchall_52
...
.method private doWriteInternal(Ljava/lang/String;JJLandroid/os/ParcelFileDescriptor;)Landroid/os/ParcelFileDescriptor;
    ...
    monitor-exit v5
    :try_end_30
    .catchall {:try_start_b .. :try_end_30} :catchall_155
    ...
    move-result-wide v5
    :try_end_4d
    .catch Landroid/system/ErrnoException; {:try_start_43 .. :try_end_4d} :catch_14f
    ...
    :try_end_57
    .catchall {:try_start_4e .. :try_end_57} :catchall_12f
    ...
    throw v0
    :try_end_b1
    .catch Landroid/system/ErrnoException; {:try_start_58 .. :try_end_b1} :catch_14f
    ...
    :try_end_c0
    .catchall {:try_start_b2 .. :try_end_c0} :catchall_ed
    ...
    monitor-enter v4
    :try_end_d5
    .catch Landroid/system/ErrnoException; {:try_start_cc .. :try_end_d5} :catch_14f
    ...
    monitor-exit v4
    :try_end_ea
    .catchall {:try_start_d5 .. :try_end_ea} :catchall_e8
    ...
    monitor-enter v4
    :try_end_fa
    .catch Landroid/system/ErrnoException; {:try_start_ea .. :try_end_fa} :catch_14f
    ...
    monitor-exit v4
    :try_end_10d
    .catchall {:try_start_fa .. :try_end_10d} :catchall_10b
    ...
    throw v0
    :try_end_14f
    .catch Landroid/system/ErrnoException; {:try_start_111 .. :try_end_14f} :catch_14f
...
.method private static extractNativeLibraries(Ljava/io/File;Ljava/lang/String;Z)V
    ...
    move-result v3
    :try_end_17
    .catch Ljava/io/IOException; {:try_start_e .. :try_end_17} :catch_37
    ...
    throw v1
    :try_end_35
    .catch Ljava/io/IOException; {:try_start_1e .. :try_end_35} :catch_37
...
.method private validateInstallLocked(Landroid/content/pm/PackageInfo;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/pm/PackageInstallerSession;->resolveStageDirLocked()Ljava/io/File;
    :try_end_1e
    .catch Ljava/io/IOException; {:try_start_1b .. :try_end_1e} :catch_3e2
    ...
    move-result-object v0
    :try_end_226
    .catch Landroid/content/pm/PackageParser$PackageParserException; {:try_start_20a .. :try_end_226} :catch_3ba
    ...
    :try_end_354
    .catch Ljava/io/IOException; {:try_start_350 .. :try_end_354} :catch_385
...
.method public open()V
    ...
    move-result-wide v3
    :try_end_29
    .catchall {:try_start_11 .. :try_end_29} :catchall_58
    ...
    :try_end_32
    .catchall {:try_start_29 .. :try_end_32} :catchall_41
    ...
    monitor-exit v0
    :try_end_4f
    .catchall {:try_start_32 .. :try_end_4f} :catchall_58
