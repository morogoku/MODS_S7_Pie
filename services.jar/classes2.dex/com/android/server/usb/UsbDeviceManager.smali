...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbSettingsManager;Lcom/android/server/utils/sysfwutil/DexObserver;)V
    ...
    iput-boolean v10, v8, Lcom/android/server/usb/UsbDeviceManager;->mBatteryWaterConnector:Z

    iput-boolean v10, v8, Lcom/android/server/usb/UsbDeviceManager;->mIsHiccupState:Z
    ...
    iput-object v0, v8, Lcom/android/server/usb/UsbDeviceManager;->mPowerConnectionReceiver:Landroid/content/BroadcastReceiver;

    new-instance v0, Lcom/android/server/usb/UsbDeviceManager$4;

    invoke-direct {v0, v8}, Lcom/android/server/usb/UsbDeviceManager$4;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V
    ...
    .catch Ljava/util/NoSuchElementException; {:try_start_5c .. :try_end_5f} :catch_60
    ...
    invoke-direct {v1, v8}, Lcom/android/server/usb/UsbDeviceManager$5;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V

    new-instance v2, Lcom/android/server/usb/UsbDeviceManager$6;

    invoke-direct {v2, v8}, Lcom/android/server/usb/UsbDeviceManager$6;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V

    new-instance v3, Lcom/android/server/usb/UsbDeviceManager$7;

    invoke-direct {v3, v8}, Lcom/android/server/usb/UsbDeviceManager$7;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V

    new-instance v4, Lcom/android/server/usb/UsbDeviceManager$8;

    invoke-direct {v4, v8}, Lcom/android/server/usb/UsbDeviceManager$8;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V
    ...
    iget-object v7, v8, Lcom/android/server/usb/UsbDeviceManager;->mPowerConnectionReceiver:Landroid/content/BroadcastReceiver;

    new-instance v10, Landroid/content/IntentFilter;

    const-string v12, "com.samsung.server.BatteryService.action.SEC_BATTERY_EVENT"
...
.method static synthetic access$1500()Lcom/android/server/utils/sysfwutil/DexObserver;
    .registers 1
...
.method static synthetic access$1700(Z)Ljava/lang/String;
    .registers 2
...
.method static synthetic access$200(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mBatteryWaterConnector:Z

    return v0
.end method

.method static synthetic access$2000(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    .registers 3
...
.method static synthetic access$202(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mBatteryWaterConnector:Z
...
.method static synthetic access$300(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mIsHiccupState:Z
...
.method static synthetic access$302(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mIsHiccupState:Z

    return p1
.end method

.method static synthetic access$400(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)V
    .registers 2
...
.method static synthetic access$500(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/ContentResolver;
    .registers 2
...
.method static synthetic access$700(Lcom/android/server/usb/UsbDeviceManager;Z)V
    .registers 2
...
.method private validateDeviceRestriction(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lcom/android/server/usb/UsbDeviceManager$UsbHandlerLegacy;->access$1200(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
