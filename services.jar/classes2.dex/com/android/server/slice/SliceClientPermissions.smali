...
.method public static createFrom(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/slice/DirtyTracker;)Lcom/android/server/slice/SliceClientPermissions;
    ...
    :goto_42
    iput-boolean v6, v4, Lcom/android/server/slice/SliceClientPermissions;->mHasFullAccess:Z
    ...
    invoke-direct {v6, v7}, Lcom/android/server/slice/SlicePermissionManager$PkgUser;-><init>(Ljava/lang/String;)V

    new-instance v7, Lcom/android/server/slice/SliceClientPermissions$SliceAuthority;

    sget-object v8, Lcom/android/server/slice/SliceClientPermissions;->NAMESPACE:Ljava/lang/String;
    ...
    invoke-direct {v7, v8, v6, v4}, Lcom/android/server/slice/SliceClientPermissions$SliceAuthority;-><init>(Ljava/lang/String;Lcom/android/server/slice/SlicePermissionManager$PkgUser;Lcom/android/server/slice/DirtyTracker;)V
    ...
    iget-object v8, v4, Lcom/android/server/slice/SliceClientPermissions;->mAuths:Landroid/util/ArrayMap;

    new-instance v9, Lcom/android/server/slice/SlicePermissionManager$PkgUser;

    invoke-virtual {v7}, Lcom/android/server/slice/SliceClientPermissions$SliceAuthority;->getAuthority()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v6}, Lcom/android/server/slice/SlicePermissionManager$PkgUser;->getUserId()I

    move-result v11

    invoke-direct {v9, v10, v11}, Lcom/android/server/slice/SlicePermissionManager$PkgUser;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v8, v9, v7}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_96
    .catch Ljava/lang/IllegalArgumentException; {:try_start_66 .. :try_end_96} :catch_97
    ...
    const-string v7, "SliceClientPermissions"

    const-string v8, "Couldn\'t read PkgUser"
