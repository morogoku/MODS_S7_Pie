...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;)V
    ...
    move-result-object v0
    :try_end_158
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_146 .. :try_end_158} :catch_222
    ...
    :try_end_192
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_15a .. :try_end_192} :catch_220
    ...
    :try_start_1a4
    invoke-static/range {v14 .. v21}, Landroid/view/SurfaceControl;->screenshotToBufferWithSecureLayersUnsafe(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZI)Landroid/graphics/GraphicBuffer;

    move-result-object v0
    :try_end_1a8
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_1a4 .. :try_end_1a8} :catch_21e
    ...
    :try_start_1ab
    invoke-virtual {v5, v3}, Landroid/view/Surface;->attachAndQueueBuffer(Landroid/graphics/GraphicBuffer;)V
    :try_end_1ae
    .catch Ljava/lang/RuntimeException; {:try_start_1ab .. :try_end_1ae} :catch_1b2
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_1ab .. :try_end_1ae} :catch_21e
    ...
    invoke-static {v0, v3}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_21d
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_1b4 .. :try_end_21d} :catch_21e
