...
.field private mRoundedDefaultHeight:I
...
.field private mRoundedDefaultWidth:I
...
.method private hasRoundedCorners()Z
    ...
    iget v0, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultWidth:I

    if-gtz v0, :cond_1

    iget v0, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultHeight:I
...
.method private updateRoundedCornerRadii()V
    ...
    :goto_1
    iget v8, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultWidth:I

    if-ne v8, v1, :cond_3

    iget v8, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultHeight:I
    ...
    iput v1, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultWidth:I

    iput v2, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultHeight:I

    iput v3, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultTop:I

    iput v4, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultBottom:I

    const-string/jumbo v6, "sysui_rounded_size"

    const/4 v7, 0x0

    invoke-virtual {p0, v6, v7}, Lcom/android/systemui/ScreenDecorations;->onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v3, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultWidth:I

    iget v4, p0, Lcom/android/systemui/ScreenDecorations;->mRoundedDefaultHeight:I
    ...
    iget v6, p0, Lcom/android/systemui/ScreenDecorations;->mDensity:F
    :try_end_0
    ...
    iget-object v7, p0, Lcom/android/systemui/ScreenDecorations;->mOverlay:Landroid/view/View;

    invoke-virtual {v7, v6}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v7

    invoke-direct {p0, v7, v3, v4}, Lcom/android/systemui/ScreenDecorations;->setSize(Landroid/view/View;II)V
    ...
    iget-object v7, p0, Lcom/android/systemui/ScreenDecorations;->mBottomOverlay:Landroid/view/View;

    invoke-virtual {v7, v6}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v6

    invoke-direct {p0, v6, v3, v4}, Lcom/android/systemui/ScreenDecorations;->setSize(Landroid/view/View;II)V

    iget-object v6, p0, Lcom/android/systemui/ScreenDecorations;->mBottomOverlay:Landroid/view/View;

    invoke-virtual {v6, v5}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v5

    invoke-direct {p0, v5, v3, v4}, Lcom/android/systemui/ScreenDecorations;->setSize(Landroid/view/View;II)V
    ...
    invoke-direct {p0, v7, v1}, Lcom/android/systemui/ScreenDecorations;->setSize(Landroid/view/View;I)V
    ...
    invoke-direct {p0, v6, v2}, Lcom/android/systemui/ScreenDecorations;->setSize(Landroid/view/View;I)V
    ...
    invoke-direct {p0, v5, v2}, Lcom/android/systemui/ScreenDecorations;->setSize(Landroid/view/View;I)V
