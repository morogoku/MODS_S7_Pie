...
.method public updateRowStates()V
    ...
    iget-object v1, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->notification:Landroid/service/notification/StatusBarNotification;

    invoke-virtual {v8, v1}, Lcom/android/systemui/statusbar/phone/NotificationGroupManager;->isChildInGroupWithSummary(Landroid/service/notification/StatusBarNotification;)Z
    ...
    iget v8, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->sanitizing:I
    ...
    invoke-virtual {v2, v9}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setIsSanitized(Z)V
    ...
    :goto_6
    invoke-virtual {v2, v3}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setOnKeyguard(Z)V
    ...
    invoke-interface {v8}, Lcom/android/systemui/statusbar/NotificationPresenter;->isDozing()Z

    move-result v8

    invoke-virtual {v9, v8}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setShowAmbient(Z)V
    ...
    invoke-virtual {v9, v11}, Lcom/android/systemui/statusbar/phone/NotificationGroupManager;->isSummaryOfSuppressedGroup(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-direct {v0, v11}, Lcom/android/systemui/statusbar/NotificationViewHierarchyManager;->isMusicServiceBoxNotification(Ljava/lang/String;)Z
    ...
    iget-object v15, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->notification:Landroid/service/notification/StatusBarNotification;
    ...
    iget-object v11, v0, Lcom/android/systemui/statusbar/NotificationViewHierarchyManager;->mEntryManager:Lcom/android/systemui/statusbar/NotificationEntryManager;
    ...
    iget-object v13, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->key:Ljava/lang/String;

    invoke-virtual {v11, v13}, Lcom/android/systemui/statusbar/NotificationData;->isAmbient(Ljava/lang/String;)Z
    ...
    invoke-virtual {v13, v11}, Lcom/android/systemui/statusbar/NotificationData;->getVisibilityOverride(Ljava/lang/String;)I
    ...
    iget-object v14, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->key:Ljava/lang/String;
    ...
    iget-object v13, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->row:Lcom/android/systemui/statusbar/ExpandableNotificationRow;
    ...
    iget-object v14, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->row:Lcom/android/systemui/statusbar/ExpandableNotificationRow;
    ...
    :cond_29
    iget-object v7, v4, Lcom/android/systemui/statusbar/NotificationData$Entry;->mActiveAppOps:Landroid/util/ArraySet;

    invoke-virtual {v2, v7}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->showAppOpsIcons(Landroid/util/ArraySet;)V
    ...
    invoke-virtual {v4}, Lcom/android/systemui/statusbar/NotificationData$Entry;->getLockStarNotificationPreview()Lcom/samsung/systemui/splugins/lockstar/LockStarNotificationPreview;
    ...
    invoke-virtual {v7, v2}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setVisibility(I)V
    ...
    invoke-virtual {v7, v2, v4}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setInverted(ZZ)V
    ...
    invoke-interface {v2, v7}, Lcom/android/systemui/statusbar/NotificationListContainer;->setMaxDisplayedNotifications(I)V
    ...
    :goto_21
    invoke-interface {v2, v8}, Lcom/android/systemui/statusbar/NotificationPresenter;->setExpandState(Z)V
