...
.method private isSamsung321Enabled()Z
    ...
    const-string v2, "com.srph.emergency321"
    ...
    const-string v3, "com.srph.emergency321"

    invoke-static {v1, v3}, Lcom/android/systemui/util/Utils;->checkAvailablePackageSignature(Landroid/content/pm/PackageManager;Ljava/lang/String;)[Landroid/content/pm/Signature;
    ...
    const-string v5, "0848EDB80D10A557AA0D885AB3B669C915DCD6BCA8D78715568A06876AACD7CD"

    invoke-static {v4, v5}, Lcom/android/systemui/util/Utils;->matchSignature(Landroid/content/pm/Signature;Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_2

    const-string v4, "content://com.srph.emergency321.settings/settings/1"
    ...
    const-string v9, "Samsung321 - Query successful"
