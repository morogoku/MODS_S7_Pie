...
# virtual methods
.method public checkLEConnectionGuide(Z)V
    .locals 4
    ...
    sget-object v2, Landroid/bluetooth/BluetoothUuid;->HearingAid:Landroid/os/ParcelUuid;

    invoke-static {v1, v2}, Landroid/bluetooth/BluetoothUuid;->isUuidPresent([Landroid/os/ParcelUuid;Landroid/os/ParcelUuid;)Z
    ...
    :cond_3
    sget-object v2, Landroid/bluetooth/BluetoothUuid;->Hogp:Landroid/os/ParcelUuid;
    ...
    invoke-virtual {v1}, Landroid/bluetooth/BluetoothDevice;->getLeService16BitsUuidData()[Landroid/os/ParcelUuid;
    ...
    invoke-virtual {v2}, Landroid/bluetooth/BluetoothDevice;->getLeComplete16BitsUuidData()[Landroid/os/ParcelUuid;
    ...
    invoke-virtual {v2}, Landroid/bluetooth/BluetoothDevice;->getLeComplete128BitsUuidData()[Landroid/os/ParcelUuid;

    move-result-object v1

    const-string v2, "7d74f4bd-c74a-4431-862c-cce884371592"
    ...
    sget v3, Lcom/android/settingslib/R$string;->bluetooth_le_connection_guide:I

    invoke-virtual {v2, v3}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/android/settingslib/bluetooth/Utils;->showToast(Landroid/content/Context;Ljava/lang/String;)V
...
.method public getConnectionSummary()Ljava/lang/String;
    ...
    sget v2, Lcom/android/settingslib/R$string;->bluetooth_summary_addr_switched_device:I
...
.method public isAddrSwitchedDevice()Z
    ...
    iget-boolean v0, p0, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mIsAddrSwitched:Z
...
.method public startPairing()Z
    ...
    invoke-virtual {v2, v1}, Landroid/bluetooth/BluetoothDevice;->createBond(I)Z
